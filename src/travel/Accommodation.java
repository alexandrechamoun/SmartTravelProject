...
/*
Abstract base class for all accommodation types.
Holds shared attributes like name, location, and price per night.
Also declares calculateCost(int numberOfDays) as abstract. IDs start at A4001.
 */
...
abstract public class Accommodation {
	...
	public boolean equals(Object obj) {
		...
		// At this point we know obj is not null and is an Accommodation.
		// We cast obj from type Object to type Accommodation so we can
		// access Accommodation-specific fields.
